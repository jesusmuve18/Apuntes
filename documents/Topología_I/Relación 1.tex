...
\begin{ejercicio}\label{ej:3.1.16}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \begin{description}
            ...
            Veamos que $0\notin A^\circ$. Supongamos que $0\in A^\circ$. Entonces, $\exists W\in \cc{T}$ con $x\in W\subset A$. Sea $W=U\cup V$, con $U\in \cc{T}_u$, $V\subset \bb{R}\setminus \bb{Q}$. Como $0\in \bb{Q}$, tenemos que $x\in U$. Por tanto, $\exists U\in \cc{T}_u$, con $0\in U\subset [0,1]$, lo cual es trivialmente una contradicción. Análogamente, se tiene que $1\notin A^\circ$. Por tanto, deducimos que $A^\circ \subset~]0,1[$.

            \item[$\supset)$] Como $]0,1[~\in \cc{T}_u\subset \cc{T}$, tenemos que $]0,1[\subset A^\circ$.
        \end{description}

        Por tanto, tenemos que $A^\circ = ]0,1[$. Además, en el segundo apartado hemos probado que $A\in C_\cc{T}$, por lo que $A=\ol{A}=[0,1]$. Por tanto, tenemos que:
        \begin{equation*}
            A^\circ = ]0,1[,\quad \ol{A}=[0,1],\quad \partial A=\ol{A}\setminus A^\circ = \{0,1\}
        \end{equation*}

        Trabajamos ahora con $B$. De manera análoga al caso anterior, tenemos que $0\notin B^\circ$, por lo que $B^\circ \subset ]0,\sqrt{2}[$, pero como $]0,\sqrt{2}[~\in \cc{T}$, tenemos que $B^\circ = ~]0,\sqrt{2}[$. Además, en el segundo apartado hemos probado que $B\in C_\cc{T}$, ya que $\sqrt{2}\in \bb{R}\setminus \bb{Q}$. Por tanto, tenemos que $\ol{B}=B$. Por tanto,        
        \begin{equation*}
        ...
        Veamos en primer lugar que $\{x\}\in C_\cc{T}$:
        \begin{equation*}
            \bb{R}\setminus \{x\} = ]-\infty,x[ ~\cup~ ]x,+\infty[\in \cc{T}_u\subset \cc{T}
        \end{equation*}
        Por tanto, tenemos que $\{x\}\in C_\cc{T}$, por lo que $\ol{\{x\}}=\{x\}$.
...
\begin{ejercicio} \label{ej:Sucesiones}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \begin{description}
            ...
            En concreto, y como $\{U\in \cc{T}\mid x\in U\}\subset N_x$ tenemos que $\forall U\in \cc{T}$ con $x\in U$, $\exists n_0\in \bb{N}$ tal que $x_n\in U$ para todo $n\geq n_0$.
            ...
            \end{equation*}
            Por tanto, tenemos que $\bb{R}\setminus U$ es numerable, ya que $\bb{R}$ no es numerable pero $U$ sí. Por tanto, $U\in \cc{T}_{CF}$. Además, claramente $x\in U$. Por tanto, y aplicando que la sucesión converge a $x$, tenemos que $\exists n_0\in \bb{N}$ tal que $x_m\in U$ para todo $m\geq n_0$.
        ...
        Notemos que en la demostración tan solo se usa que $\bb{R}$ no es numerable, por lo que este resultado es cierto para todo $(X,\cc{T}_{CF})$ con $X$ no numerable.

        \item \label{ej:Sucesiones.LimiteEnAdherencia}
        Sea $(X,\cc{T})$ un espacio topológico, y $A\subset X$ un subconjunto no vacío. Supongamos que existe $\{a_n\}_{n\in \bb{N}}$ una sucesión de puntos en $A$ que converge a un punto $x\in X$. Entonces $x\in \ol{A}$.
