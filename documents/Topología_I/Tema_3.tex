...
\begin{teo}
    (Teorema de Borsuk-Ulam) Si $f:(\bb{S}^n, \cc{T}_u)\to (\bb{R}, \cc{T}_u)$ continua, entonces $\exists p_0\in \bb{S}^n$ tal que $f(p_0)=f(-p_0)$.
    \begin{proof}
...
\begin{prop}
    ...
    \begin{proof}\
        \begin{itemize}
            ...
            \end{align*}
            Por lo que $X\times Y$ es unión de conexos y $(X \times \{y_0\})$ tiene intersección con todos los $\{x\}\times Y$ luego $X\times Y$ es conexo.
...
\begin{prop}
    ...
    \begin{enumerate}
        ...
        \item[(ii)] Las c.c. de $(X, \cc{T})$ determinan una partición de $X$, es decir que $\bigcup\limits_{x\in X}\cc{C}(x)=X$ y $\forall x,y\in X$ se tiene que o bien $\cc{C}(x)=\cc{C}(y)$ o bien $\cc{C}(x)\cap \cc{C}(y)=\emptyset$.
        \item[(iii)] $(X, \cc{T})$ es conexo si y solo sí tiene una única c.c., es decir, $\cc{C}(x)=X$\ \ $\forall x \in X$.
        ...
        \item[(vi)] Si $\{A_i\}_{i\in I}\subset \cc{T}$, $A_i$ conexo $\forall i \in I$, es una partición de $X$ , es decir, $\bigcup\limits_{i\in I}A_i=X$ y $A_i\cap A_j=\emptyset$\ \ $\forall i \neq j$, entonces $\{A_i\}_{i\in I}$ son las c.c. de $(X, \cc{T})$ (de nuevo la otra implicación no es cierta ya que no siempre la partición tiene que ser por abiertos).
    \end{enumerate}
    \begin{proof}\
        \begin{enumerate}
            \item[(i)] Trivial, porque la unión de conexos con intersección no vacía es conexa.
            \item[(ii)] Como $x\in \cc{C}(x) \Rightarrow \bigcup\limits_{x\in X}\cc{C}(x)=X$. Veamos ahora la segunda parte. Para ello supongamos que tenemos dos componentes conexas de forma que $\cc{C}(x)\cap \cc{C}(y)\neq \emptyset $, tendré que ver que entonces $\cc{C}(x)=\cc{C}(y)$. Como la intersección es no vacía tengo que $x,y,\in \cc{C}(x)\cup \cc{C}(y)$ y es conexo por lo que $\cc{C}(x)\cup \cc{C}(y)\subset \cc{C}(x)$ y también $\cc{C}(x)\cup \cc{C}(y)\subset \cc{C}(y)$ por lo que $\cc{C}(x)\cup \cc{C}(y)\subset \cc{C}(x)\cap \cc{C}(y)$ y por tanto $\cc{C}(x)=\cc{C}(y)$.
            \item[(iii)] Trivial.
            \item[(iv)] Sea $x\in X$ y queremos ver que $\cc{C}$ es cerrado, es decir, que coincide con su adherencia. Para ello sabemos que $\overline{\cc{C}(x)}$ es conexo y además $x\in \overline{\cc{C}(x)}$ por lo que $\overline{\cc{C}(x)}\subset \cc{C}(x)$ y como la otra inclusión se da siempre ya lo tenemos probado.
            \item[(v)] Sea $x\in A$, tendremos que ver que $A=\cc{C}(x)$. Sea $B\subset X$ conexo con $A\subset B$. Si esto implica que $A=B$ entonces tendré que $A$ es una componente conexa (ya que no hay ningún conexo más grande). Para ello tenemos que 
            \begin{align*}
                \left.
                \begin{array}{ccc}
...
\begin{teo}
    Sea $f:(X, \cc{T})\to (Y, \cc{T}')$ una aplicación continua, $x\in X$ y sea $\cc{C}(x)$ la c.c. de $X$ que contiene a $x$ y $\cc{C}'(f(x))$ a la c.c. de $Y$ que contiene a $f(x)$. Entonces $f(\cc{C}(x))\subset \cc{C}'(f(x))$. 
...
\begin{teo}
    (Teorema de Heine-Borel generalizado) Un subespacio de $(\bb{R}^n, \cc{T}_u)$ es compacto si y solo si es cerrado y acotado.
    \begin{proof}\
        \begin{itemize}
