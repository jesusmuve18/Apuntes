...
\begin{prop}
    ...
    \begin{proof}
        Sea $\{U_i'\}_{i\in I}$ un recubrimiento de $f(X)$ por compactos de $\cc{T}'$, $f(X)\subset \bigcup\limits_{i\in I}U_i'$. Consideramos $\{f^{-1}(U_i')\}_{i\in I}$. Tenmemos $\bigcup\limits_{i\in I}f^{-1}(U_i) = f^{-1}(\bigcup\limits_{i\in I} U_i') \supset f^{-1}(f(X)) = X$. Como $X$ es compacto tenemos que $\exists i_1, \dots, i_n \in I$ con $X = \bigcup\limits_{j=1}^n f^{-1}(U_{ij}') \Rightarrow f(X)=f(\bigcup\limits_{j=1}^n f^{-1}(U_{ij}')) = \bigcup\limits_{j=1}^n f(f^{-1}(U_{ij}')) \subset \bigcup\limits_{j=1}^n U_{ij}$.
    \end{proof}

    % \begin{proof}
    %     Sea $\{U_i'\}_{i\in I}\subset \cc{T}'$ un recubrimiento de $f(X)$ por abiertos de $\cc{T}'$, sabemos que $f(X)\subset \bigcup_{i\in I}U_i' \Rightarrow \{f^{-1}(U_i')\}_{i\in I}$
    % \end{proof}
\end{prop}
