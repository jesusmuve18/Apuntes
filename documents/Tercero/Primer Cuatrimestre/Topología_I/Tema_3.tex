...
\begin{teo}
    ...
    \begin{proof}\
        \begin{itemize}
            ...
            \item[$\Leftarrow$ )] Sea $S\subset \bb{R}^n$ cerrado y acotado. Como $S$ es acotado está contenido en una bola y en particular considerando la norma infinito tenemos que $\exists r>0$ tal que $S\subset [-r,r]\times \dots\times [-r,r]$. Por el teorema de Heine-Borel sabemos que cada $[-r,r]$ es compacto y por Tijonov sabemos que el producto de compactos es compacto. Tenemos que $S$ es acotado y está contenido en un compacto luego $S$ es compacto.  %TODO: revisar
        \end{itemize}
    \end{proof}
\end{teo}
