...
\begin{definicion}
    ...
    Equivalentemente, $\forall N'\in \cc{N}_{f(x_0)}'$ se tiene que  $f^{-1}(N')\in \cc{N}_{x_0}$. Es decir, la imagen inversa por $f$ de todo entorno de $f(x_0)$ en el espacio topológico $\cc{T}'$ es entorno de $x_0$ en el espacio topológico $\cc{T}$.
    \endsquare
\end{definicion}
...
\begin{prop}
    ...
    \begin{enumerate}
        ...
        \item[(v)] Si $x\in X$, $\beta_x\subset \cc{P}(X)$, entonces $\beta_x$ es b.d.e. de $x$ en $\cc{T} \sii \cc{B}_{f(x)}'=f(\beta_x)=\{f(V):V\in \beta_x\}$ es b.d.e. de $f(y)$ en $\cc{T}'$.     
    \end{enumerate}
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            ...
            \item[(v)] Sea $N'\in \cc{N}_{f(x)}'$. Por (iv) (la implicación hacia la izquierda) tenemos que $f^{-1}(N')\in \cc{N}_x$. Como tenemos una b.d.e tenemos que $\exists V \in \beta_x$ con $V\subset f^{-1}(N') \Rightarrow f(V)\subset N'$ y de nuevo por (iv) tenemos que $f(V)\in \cc{N}_{f(x)}'$ y tenemos lo que queríamos.
            \begin{center}
                \begin{tikzpicture}
                    \def\incolor{gray!20}
...
\begin{prop}
    ...
    \begin{enumerate}
        ...
        \item[(ii)] Si $x\in X$, $\beta_x$ b.d.e. de $x$ en $(X, \cc{T})$ y $y\in Y$, $\beta_y'$ b.d.e. de $y$ en $(Y, \cc{T}')$, entonces
        \begin{gather*}
            \tilde{\cc{B}}_{(x,y)}=\beta_x\times \beta_y' =\{V\times V': V\in \beta_x, V'\in \beta_y'\}
        \end{gather*}
