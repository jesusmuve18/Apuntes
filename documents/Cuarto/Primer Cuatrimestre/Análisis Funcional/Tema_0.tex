...
\begin{teo}[Teorema de la aplicación abierta]
    ...
    \begin{proof}\
        \begin{itemize}
            ...
            y podemos garantizar que $\exists \{u_m\}\subset X$, $\exists \{v_m\}\subset Y$ tales que si podemos escribir $y=T(u_n) + v_n$, entonces 
            \begin{gather*}
                \|u_n\| + n\|v_n\|_Y <1\ \ \ \text{ y }\ \ \ \{\|u_m\|_X + n\|v_m\|_Y\}_{m\in \bb{N}} \to \|y\|_n
            \end{gather*}
            ...
            \begin{gather*}
                ...
                \begin{array}{r}
                    ...
                    n\|v_m\|_Y<1
                \end{array}
                \right\} \forall m \in \bb{N} \Rightarrow
                \left.
                \begin{array}{r}
                    \|u_m\|_X<1\\
                    \|v_m\|_Y<\frac{1}{n}
                \end{array}
                \right\} \forall m \in \bb{N}
            \end{gather*}
            Por lo que 
            \begin{gather*}
                T(\{u_m\}) = \{T(u_m) + v_m - v_m\} = \{y-v_m\}\\
                \|T(u_m)\|_Y = \|y-v_m\|_Y \to
            \end{gather*}
            
            \item[\textbf{Paso 2.}] Vamos a demostrar ahora que $B_Y(0,\nicefrac{r}{2})\subset T(B_X(0,1))$.
        \end{itemize}
    \end{proof}
\end{teo}
