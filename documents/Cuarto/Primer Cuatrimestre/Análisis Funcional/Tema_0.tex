...
\begin{observacion}
    ...
    \begin{proof}\ %TODO: formatear un poco mejor y poner productos 
        \begin{itemize}
            ...
            \begin{gather*}
                \|T(x)\| = \left\| T \left(\frac{x}{\|x\|} \|x\| \frac{\delta}{2} \frac{2}{\delta}\right) \right\| = \frac{2}{\delta}\left\| T\left(\frac{x}{\|x\|} \frac{\delta}{2} \right) \right\| < \frac{2}{\delta}\|x\|
            \end{gather*}
            ...
            \item [(iv)$\Rightarrow$(ii) )] Por hipótesis tenemos que si $\|x\|<1$ entonces $\|T(x)\|\leq R$ y queremos probar que $\forall \veps >0 \ \ \exists \delta>0$ tal que si $\|x\|<\delta$, entonces $\|T(x)\|<\veps$. Tomamos $\delta = \frac{\veps}{2R}$ y tenemos que
            \begin{gather*}
