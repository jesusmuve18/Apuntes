...
\begin{observacion}
    ...
    \begin{proof}\ 
        \begin{itemize}
            ...
            \item [(iv)$\Rightarrow$(ii) )] Por hipótesis tenemos que si $\|x\|<1$ entonces $\|T(x)\|\leq R$ y queremos probar que $\forall \veps >0 \ \ \exists \delta>0$ tal que si $\|x\|<\delta$, entonces $\|T(x)\|<\veps$. Tomamos $\delta = \frac{\veps}{2R}$ y como $x\in E$, entonces $\|x\|<\delta$ y tenemos que
            \begin{gather*}
