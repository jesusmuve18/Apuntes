...
func _ready():
	var estrella_z = ArrayMeshEstrellaZ(n_lados)
	var mesh_instance = MeshInstance3D.new()
	mesh_instance.mesh = estrella_z
...
# Dado un numero de lados devuelve la malla la estrella con dicho numero de puntas y 
