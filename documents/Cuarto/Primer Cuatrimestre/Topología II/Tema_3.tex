...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
            \begin{scope}[shift={(0,0)}]
                ...
                % Flechas
                % \draw[->] (0,0.75) ++(0, 0.01) -- ++(0,-0.01); %1
                % \draw[->] (0.75,0) ++(-0.01,0) -- ++(0.01,0); %2
                \draw[->] (1.5,0.75) ++(0, -0.01) -- ++(0,0.01); %3
            ...
            \begin{scope}[shift={(3,0)}]
                ...
                % Flechas
                \draw[<-] (0.5,0.73) ++(0, 0.01) -- ++(-0.01,-0.01); %1
                % \draw[->] (1,0) ++(-0.01,0) -- ++(0.01,0); %2
                % \draw[->] (1.5,0.73) ++(0, -0.01) -- ++(-0.01,0.01); %3
            \end{scope}
    \end{tikzpicture}
\end{figure}
...
\end{gather*}
Esto siempre se podrá hacer siempre que $w_i'$ y $w_i''$ se queden con al menos de 3 símbolos.
