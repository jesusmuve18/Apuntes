...
Pasamos ahora a calcular el grupo fundamental de $\bb{R}\bb{P}_n^2$.
...
Con un proceso análogo al del $n$-toro tendremos que 
\begin{gather*}
...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \item Consideramos la presentación de $\bb{R}\bb{P}_n^{1}$, $\cc{P}=\{a_1,...,a_n;\ a_1a_1...a_na_n\}$.
        
        Donde tendremos ya probado que solo hay un vértice por lo que 
        \begin{gather*}
            C=1\\
            A=n\\
            V=1
...
\begin{observacion}
    ...
    \begin{gather*}
        ...
        \chi(\bb{R}\bb{P}_n^2) = 2-n\ (\leq 0),\ n\geq 1
    \end{gather*}
    Si la superficie que queremos estudiar tuviera característica positiva o impar sería muy fácil de clasificar. Si por el contrario tuviéramos un número negativo par aún no sabríamos clasificarlo.
\end{observacion}
