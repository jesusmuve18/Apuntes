...
\begin{enumerate}
    ...
    \begin{proof}
        ...
        En este proceso para el nuevo polígono hay un vértice menos en $[v_0]$. 
        
        Con todo esto tendríamos la siguiente situación:
        \begin{gather*}
            w=ya_1a_1...a_ka_k
        \end{gather*}
        donde solo hay un vértice en el cociente.
        \begin{itemize}
...
\begin{enumerate}
    ...
    \item $b_1c_1b_1^{-1}c_1^{-1}...\ b_lc_lc_l^{-1}c_l^{-1} \equiv $ $l$-toro
\end{enumerate}
...
\begin{gather*}
    ...
    \end{array}
\end{gather*}
Calculemos el grupo fundamental del $n$-toro. Este será $P_0$ bajo la reslación de equivalencia $R$ que identifica a los lados con igual nombre, es decir
\begin{gather*}
    \bb{T}_n = \frac{P_0}{R}
\end{gather*}
