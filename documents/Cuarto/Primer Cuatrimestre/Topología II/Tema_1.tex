...
\begin{teo}
    ...
    \begin{proof}
        ...
        \end{gather*}
        Sabiendo que $\hat{\alpha}(1) = \phi([\alpha])$ y $\hat{\beta}(1) = \phi([\beta])$. Como $\hat{\alpha}(1)=\hat{\beta}(1)$ consideramos $\hat{\alpha} \ast \hat{\tilde{\beta}}$ que es un lazo basado en $r_0$. Como $R$ es simplemente conexo tenemos que
        \begin{gather*}
            [\hat{\alpha}] \ast \left[\hat{\tilde{\beta}}\right] = \left[\hat{\alpha} \ast \hat{\tilde{\beta}}\right] = [\veps_{r_0}]
        \end{gather*}
        por lo que se tiene 
        \begin{gather*}
    ...
    \begin{proof}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                ...
                \node[blue, anchor=north west] at (1.5, -0.25) {$(|x|=1)$};
                ...
                \draw[blue, dashed] (0.75,0.5) -- (1.33,1) -- (1.33,2.5);
