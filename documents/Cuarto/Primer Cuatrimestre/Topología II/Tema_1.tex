...
\begin{ejemplo} En este caso, si consideramos la aplicación $p:\bb{R} \to \bb{S}^1$ descrita en la gráfica, que es claramente continua y sobreyectiva\footnote{de hecho es un homeomorfismo que estudiamos en Topología I} podemos ver que $O$, que contiene al $(1,0)$ está regularmente recubierto
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}
            \shorthandoff{>}
