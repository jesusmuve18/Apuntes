...
\begin{lema}
    ...
    \begin{proof}
       ...
       \end{gather*}
       De forma recursiva se verifica la unicidad en todos los intervalos $[t_j, t_j+1]$ con $j\in \{0,\dots,r-1\}$.
    \end{proof}
\end{lema}
