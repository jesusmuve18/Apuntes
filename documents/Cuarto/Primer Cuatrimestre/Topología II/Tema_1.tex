...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        De forma análoga si consideramos $V=X\setminus \{(0,0,-1)\}$ se tiene que $\pi_1(V)$ es trivial. Claramente se tiene que $U\cap V$ es arcoconexo\footnote{en un examen habrá que demostrarloo de forma más rigurosa} y por el teorema anterior se tiene que $X$ es simplemente conexo, luego su grupo fundamental es el trivial.
    \end{enumerate}
\end{ejemplo}
