...
\begin{teo}
    ...
    \begin{proof}
        ...
        Como coinciden los elementos del grupo fundamental tendremos que son homotópicos por arcos por lo que existe una homotopía por arcos $H$ entre $\hat{\alpha}$ y $\hat{\beta}$, es decir, una aplicación $H:R\times [0,1] \to R$ tal que 
        \begin{gather*}
            H(t,0) = \hat{\alpha}(t) \ \ \ \text{ y } \ \ \ H(t, 1) = \hat{\beta}(t)
        \end{gather*}
        Si consideramos ahora su composición con la aplicación recubridora, $p\circ H$, tendremos que es una homotopía entre $\alpha$ y $\beta$ ya que tendríamos $p\circ H : R \times [0,1] \to B$ que verifica
        \begin{gather*}
...
\begin{teo}
    ...
    \begin{proof}
        ...
        \end{align*}
        por lo que $\widehat{\alpha\ast\beta}$ es un levantamiento de $\alpha \ast \beta$ con $\hat{\alpha \ast \beta}(0) = \widehat{\alpha}(0)$ por lo que por definición tenemos que 
        \begin{gather*}
            \deg(\widehat{\alpha \ast \beta}) = \widehat{\alpha \ast \beta}(1) = \hat{\alpha}(1) + \hat{\beta}(1) = \deg(\alpha) + \deg(\beta)
        \end{gather*}
    \end{proof}
\end{teo}
...
\begin{coro}
    ...
    \begin{proof}\
        ...
        \end{gather*}
        es biyectiva (ya que $\bb{S}^1$ es simplemente conexo). Entonces $\pi_1(\bb{R}P^n, [a_0])$ solo tiene dos elementos, luego $\pi_1(\bb{R}P^n, [a_0]) \cong \bb{Z}_2$.
    \end{proof}
\end{coro}
