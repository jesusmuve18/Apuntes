...
\begin{teo}
    ...
    \begin{coro}
        ...
        \begin{proof}
            ...
            \end{gather*}
            donde $R$ es la relación de equivalencia ``ser homotópico por arcos''. Veamos ahora que esta $G$ recién definida tiene estructura de grupo:
            \begin{enumerate}
...
\begin{ejemplo}\ \\ % TODO
    ...
    En $\bb{R}^2\setminus\{(0,0)\}$ tenemos que $[\veps_{x_0}] \neq [\alpha] \neq [\tilde{\alpha}] \neq [\beta]$ y probaremos más adelante que $\pi_1(X,x_0)$ es isomorfo a $\bb{Z}$ aunque intuitivamente se puede entender el 0 como el lazo trivial (el que no rodea a $(0,0)$), los números positivos son .
\end{ejemplo}
...
\begin{teo}
    ...
    \begin{proof}
        ...
        \end{align*}
        que está bien definida por lo visto anteriormente sobre el operador $\ast$. Queremos ver ahora 
    \end{proof}
\end{teo}
