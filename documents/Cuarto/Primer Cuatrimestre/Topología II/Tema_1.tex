...
\begin{teo}
    ...
    \begin{proof}
        ...
        Como coinciden los elementos del grupo fundamental tendremos que son homotópicos por arcos por lo que existe una homotopía por arcos $H$ entre $\hat{\alpha}$ y $\hat{\beta}$, es decir, una aplicación $H:[0,1]\times [0,1] \to R$ tal que 
        \begin{gather*}
...
\begin{definicion}
    ...
    \begin{gather*}
        p(x) = (\cos(2\pi x), \sen(2\pi x))\ \ \ \ , \text{con }\hat{\alpha}(0) = 0
    \end{gather*}
...
\begin{prop}\label{prop1-12}
    ...
    \begin{proof}
        ...
        \begin{align*}
            f_*:\pi_1(\overline{\bb{D}}(1,0)) & \to \pi_1(\bb{S}^1, (1,0))\text{ es homomorfismo}\\
        ...
        \end{gather*}
        pero como $f_*([\alpha]_{\overline{\bb{D}}}) = [\alpha]_{\bb{S}^1}$ llegamos a contradicción ya que $\deg(\alpha) = 1$ y $\deg(\veps_{(1,0)}) = 0$
    \end{proof}
\end{prop}
...
\begin{observacion}\
    \begin{enumerate}
        ...
        \item[(iv)] Todo homeomorfismo es una equivalencia homotópica.
    \end{enumerate}
\end{observacion}
...
\begin{lema}
    ...
    \begin{proof}
        ...
        \begin{align*}
            ...
            (s,t) & \mapsto (\beta(s), t)
        \end{align*}
        y los siguientes lazos en $[0,1]\times [0,1]$
        \begin{align*}
            b_0(s) = (s,0)\ \ \ \ \ & ,s\in [0,1]\\
            b_1(s) = (s,1)\ \ \ \ \  & ,s\in [0,1]\\
            h_0(s) = (0,s)\ \ \ \ \  & ,s\in [0,1]\\
...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \begin{align*}
            H:Y\times [0,1] &\to Y\\
            ((x,t),t) &\mapsto (1-t)(x,y)+t\left(x, \frac{1}{2}\right)
        \end{align*}
...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \end{gather*}
        donde $i_{1*}([\gamma]_{U\cap V})^{-1} i_{2*}([\gamma]_{U\cap V})= [\gamma]_U^{-1}[\gamma]_V$ será el elemento neutro, luego $[\gamma]_U = [\gamma]_V$ y tendremos solo 3 generadores.\\
