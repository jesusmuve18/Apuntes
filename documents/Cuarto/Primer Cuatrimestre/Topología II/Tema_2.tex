...
Vamos a tratar hasta el final de este tema de clasificar los espacios recubridores de un espacio topológico $B$ dado. Para ello vamos a utilizar una nomenclatura clásica.
...
\begin{definicion}
    Sean $(R_1,p_2)$, $(R_2,p_2)$ dos espacios recubridores de un mismo e.t. base $B$, es decir, estamos en la siguiente situación
    \begin{gather*}
        \xymatrix{
...
\begin{observacion}\
    \begin{enumerate}
        ...
        \end{gather*}
        recordando que la composición de una aplicación recubridora con un isomorfismo es recubridora. Además, $\phi$ de $(\hat{R}, p\circ \phi)$ en $(R,p)$ es un isomorfismo de recubridores. De hecho, de la definición se deduce que todo isomorfismo de recubridores es de la forma anterior.

        \item Si $\phi_1$ de $(R_1,p_1)$ es $(R_2,p_2)$ es un homomorfismo de recubridores y $\phi_2$ es otro desde $(R_2,p_2)$ en $(R_3,p_3)$, entonces $\phi_2\circ \phi_1$ es un homomorfismo de recubridores de $(R_1,p_1)$ en $R_3, p_3$. Tendríamos la siguiente situación:
        \begin{gather*}
            \xymatrix{
...
\begin{coro}
    ...
    \begin{proof}
        ...
        \begin{gather*}
            \xymatrix{
                R_1 \ar@/^/[rr]^{\phi_2} \ar@/_/[rr]_{\phi_1} \ar[dr]_{p_2} && R_2 \ar[dl]^{p_2} \\
                & B
            }
        \end{gather*}
        Si $\phi_1(r_1)=\phi_2(r_1)$, como $\phi_1$ y $\phi_2$ son levantamientos de $p_1$, entonces por el teorema de unicidad del levantamiento tenemos que $\phi_1=\phi_2$.\\

        La segunda parte es aplicar la primera parte usando $\phi_1=\phi$ y $\phi_2=Id_R$.
    \end{proof}
\end{coro}
...
\begin{coro}
    ...
    \begin{proof}
        Estamos en la siguiente situación (donde se ha puesto la equivalencia con la notación que usamos para el teorema de existencia del levantamiento)
        \begin{gather*}
            \xymatrix{
        ...
        \end{gather*}
        Entonces el teorema de existencia del levantamiento nos decía que existe $\phi$ levantamiento de $p_1$ con $\phi(r_1) = r_2$ si y solo si 
        \begin{gather*}
            p_{1*}(\pi_1(R_1,r_1)) \subseteq p_{2*}(\pi_1(R_2,r_2))
        \end{gather*}
        La segunda parte es clara por la doble inclusión. Es decir tenemos        \begin{gather*}
            \xymatrix{
        ...
        \end{gather*}
        por ser $r_1$ y $r_2$ puntos fijos respectivamente.
    \end{proof}
\end{coro}
...
\begin{teo}
    ...
    \begin{proof}
        ...
        \begin{itemize}
            ...
            \end{align*}
            ya que como $\phi$ es un homeomorfismo tenemos que $\phi_*(\pi_1(R_1,r_1)) = \pi_1(R_2, \phi(r_1))$.
