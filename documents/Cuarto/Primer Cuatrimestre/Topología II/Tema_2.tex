...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \end{gather*}
        por lo que $y\in B(b,\veps)$. De esta forma tendremos que para todo $\veps>0$ existe al menos una circunferencia\footnote{de hecho infinitas ya que para todo $m'\in \bb{N}$ con $m'>m$ también se verificará} $S_m$ tal que 
        \begin{gather*}
            S_m \subseteq B(b,\veps)
        \end{gather*}
        Como $S_m\subset B$, en particular tendremos que 
        \begin{gather*}
