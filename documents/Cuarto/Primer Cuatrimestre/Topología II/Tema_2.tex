...
\begin{ejemplo}
    ...
    podemos ver que $\pi_1(\bb{S}^1,(1,0))$ está generado por $[\alpha]$ con 
    \begin{gather*}
        \alpha(t) = (\cos(2\pi t), \sen(2\pi t))
    \end{gather*}
    y $\pi_1(\bb{S}^1\times \bb{R}, (1,0,1))$ está generado por $[\beta]$ con 
    \begin{gather*}
    ...
    Como tenemos que 
    \begin{gather*}
        f_{1*}(\pi_1(\bb{S}^1, (1,0))) = \{[\beta]^k : k\in \bb{Z}\}\\
        p_*(\pi_1(\bb{S}^1 \times \bb{R}, (1,0,1))) = \{[\beta]^{2m}: m\in \bb{Z}\}
    \end{gather*}
    por lo que 
    \begin{gather*}
