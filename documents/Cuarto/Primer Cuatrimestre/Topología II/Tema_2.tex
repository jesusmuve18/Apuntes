...
\begin{observacion}
    ...
    \begin{enumerate}
        \item existe a lo más (salvo isomorfismos) un recubridor $(R,p)$ cumpliendo que existe un recubridor $(R,p)$ cumpliendo que existe un punto $r\in R$ tal que $p_*(\pi_1(R,r)) = H$.
        \begin{gather*}
            \xymatrix{
        ...
        \item Además si $H$ y $H'$ son conjugados en $\pi_1(B,b_0)$ a lo más existe un recubridor correspondiente a ambos, es decir, si $(R,p)$ es un recubridor con $r_0\in R$ tal que $p_*(\pi_1(R,r_0)) = H$, entonces también existe un $r_0'\in R$ tal que $p_*(\pi_1(R,r_0'))=H'$.
        \begin{gather*}
            \xymatrix{
                R \ar[d]_p & \pi_1(R,r)\ar[d]_{p_*} & \pi_1(R,r') \ar[d]\\
...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \begin{gather*}
            \pi_1(\bb{R},0) = \{[\veps_0]\}
        \end{gather*}
        Solo hay un subgrupo $H$. Entonces $\bb{R}$ solo tiene un recubridor
        \begin{gather*}
            (\bb{R}, p\in Id_{\bb{R}})
        \end{gather*}
        ...
        \item Consideramos ahora $\bb{R}\bb{P}^2$ el espacio proyectivo con $n\geq 2$. Tenemos que
        \begin{gather*}
        ...
        \begin{gather*}
            H_1 = \{[\veps_{x_0}]\} \to \text{ Recubridor asociado } (\bb{S}^n, p) : p(x)=[x]\\
        ...
        \begin{gather*}
            \pi_1(\bb{S}^1, (1,0)) \cong \bb{Z}\\
            \pi_1(\bb{S}^1, (1,0)) = \{[\alpha]^n : \alpha(t) = (\cos(2\pi t), \sen(2\pi t)),\ n\in \bb{Z}\}
        \end{gather*}
        ...
        \begin{gather*}
            ...
            H_0 \cong \{0\}
        \end{gather*}
        Para el recubridor $(\bb{R}, p)$ donde $p(x) = (\cos(2\pi t), \sen(2\pi t))$, su subgrupo asociado en $\pi_1(\bb{S}^1, (1,0))$ es $H_0$.\\

        También podemos considerar el recubridor $(\bb{S}, p_1=Id_{\bb{S}^1})$ cuyo subgrupo asociado es $H_1 = \pi_1(\bb{S}^1, (1,0))$.\\

        Extendemos ahora la aplicación $p_k$ para $k\geq 2$ dada por 
        \begin{align*}
            p_k : \bb{S}^1 &\to \bb{S}^1\\
        ...
        \end{gather*}
        y ya tendríamos calculados todos los recubridores de $\bb{S}^1$.

        \item Vamos a estudiar ahora el cilindro de $\bb{R}^3$, $B=\bb{S}\times \bb{R}$. Conocemos el recubridor
        \begin{gather*}
            \pi_1(\bb{S}\times \bb{R}, (1,0,0)) = \{[\alpha]^n : n\in \bb{Z}\} \cong \bb{Z}
        \end{gather*}
        \begin{align*}
            p_0 : \bb{R}^2 &\to \bb{S}\times \bb{R}\\
            (x,y) & \mapsto (\cos(2\pi x), \sen(2\pi x), y)
        \end{align*}
        asociado a $H_0=\{[\veps_{(1,0,0)}]\}$.\\

        Buscamos igual que antes la función $p_k$ para $k\in \bb{Z}^+$ dada por 
        \begin{align*}
