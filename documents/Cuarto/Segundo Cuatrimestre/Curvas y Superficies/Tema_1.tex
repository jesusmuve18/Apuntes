...
\begin{ejemplo}
    ...
    Este ejemplo nos demuestra que aunque $\veps$ sea diferenciable, $tr(\veps)$ tiene ``picos''. Tenemos que $img(\veps) = Gr\{y=x^{\frac{2}{3}}\}$, es decir, la traza de $\veps$ coincide con la gráfica de una función no diferenciable.
\end{ejemplo}
