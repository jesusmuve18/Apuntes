...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \item Consideramos ahora $\beta : \bb{R} \to \bb{R}^2$ la curva tal que $tr(\beta) = C(a,r)$ con $a=(a_1, a_2)\in \bb{R}^2$, $r>0$. La definimos en el plano $P(\{z=0\})$ de la siguiente forma
        \begin{gather*}
        ...
        \item Calculemos la longitud de la siguiente curva
        \Func{\gamma}{\bb{R}}{\bb{R}^2}{t}{(e^{-t}\cos(t), e^{-t}\sin(t)) = e^{-t}(\cos(t), \sin(t))}
        en el intervalo $[a,b]\subset \bb{R}$. En primer lugar nos haremos una idea de la forma de la curva gráficamente:
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                % --- DEFINICIÓN DE LA CURVA PARAMÉTRICA ---
                \addplot [
                    domain=-10:100, % 1. RANGO DE 't'
                    samples=1000,     % 2. SUAVIDAD: Aumenta este número (ej. 200) si la curva tiene picos raros
                    variable=\t,     % Definimos que nuestra variable paramétrica es 't'
                    thick,           % Grosor de la línea
                    blue,            % Color de la línea
                ]
        ...
        A esta curva la llamamos \textbf{espiral logarítmica}. Pasamos al cálculo:
        \begin{gather*}
            L_a^b(\gamma) = \int_a^b |\gamma'(t)| dt\\
            \gamma'(t) = e^{-t}(\cos(t), \sin(t)) + e^{-t}(-\sin(t), \cos(t))\Rightarrow\\
            \Rightarrow |\gamma'(t)|^2 = e^{-2t}+e^{-2t} = 2e^{-2t}
        \end{gather*}
        Podemos ver en nuestro estudio que $\gamma$ es regular. Podemos concluir también que
        \begin{gather*}
        ...
        \begin{gather*}
            \lim_{b\to \infty} L_a^b(\gamma) = \sqrt{2}e^{-a}
        \end{gather*}
