...
\begin{definicion}
    Sean $S,S'\subset \bb{R}^3$ superficies y $O\subset \bb{R}^3$ un abierto. Dada $f$ una aplicación definida de alguna de estas formas:
    \begin{enumerate}
        \item[a)] $f:S\to \bb{R}^m$ con $m\geq 1$.
        \item[b)] $f:O\subset \bb{R}^3 \to S$.
        \item[c)] $f:S \to S'$
    \end{enumerate}
...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        Una consecuencia de esto es la siguiente: Sea $f:S\to \bb{R}^m$ donde $S \bb{R}^3$ es una superficie. Supongamos que $\forall p \in S$ existe una parametrización $X_p:U_p\to S$ tal que $p\in X_p(U_p)$ y $f\circ X_p$ es diferenciable en el sentido de análisis, entonces $f$ es diferenciable en el sentido a).
        \begin{proof}
...
\begin{enumerate}
    \item Una curva diferenciable en una superficie $S$ es una curva $\alpha:I\to \bb{R}^3$ diferenciable tal que su traza $\alpha(I)\subset S$. 
    ...
    La identidad de una superficie en sí misma y la composición de difeomorfismos también son difeormorfismos. Por eso $S$ es difeomorfa a $S'$ es una relación de equivalencia en la colección de todas las superficies.
\end{enumerate}