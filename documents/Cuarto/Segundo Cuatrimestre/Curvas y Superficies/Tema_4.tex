...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \end{gather*}
        Consideramos $S=f^{-1}(\{a\})\subset O \subset \bb{R}^3$ con $a$ un valor regular y queremos ver si $S$ es o no una superficie. Recordamos que el Teorema de la Función implícita dice que para cada punto $p_0 = (x_0, y_0, z_0)\in S$ sabemos que $(\nabla f)_{p_0}\neq 0$. Suponemos sin pérdida de generalidad que $f_x(p_0)\neq 0$. Entonces tenemos que existe un entorno abierto $U$ de $(x_0,y_0)$ en $\bb{R}^2$, un entorno abierto $V$ de $a$ en $\bb{R}$ y una aplicación $g:U\to \bb{R}$ diferenciable tales que 
        \begin{gather*}
