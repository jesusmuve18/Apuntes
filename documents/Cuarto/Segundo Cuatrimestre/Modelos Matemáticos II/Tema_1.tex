...
\begin{gather*}
    D = \{y\in C^1([x_0, x_1]) : y(x_0) = y_0\}
\end{gather*}
con $y_0\in \bb{R}$ dado. Todo punto crítico $y_*\in D\cap C^2(I)$, además de verificar la ecuación de Euler-Lagrange, cumple también que 
\begin{gather*}
