...
int main()
{
	...
	do
	{
		...
		if(n_anios>0)
		{
			...
			/*Calculo todos los posibles valores de incrementos de IPC en 
			  todas las zonas y voy guardando el menor y el mayor que vaya
			  encontrando. 
			  
			  Para ello fijo primero una zona y luego un año inicial y lo 
			  calculo de acuerdo al número de años dado. Sigo variando el 
			  año inicial hasta que no pueda calcular más y paso a la 
			  siguiente zona y así hasta terminar las zonas */
			...
			media_max=incremento_max/n_anios;
			media_min=incremento_min/n_anios;
			...
			cout<<"\tValor: "<<media_max<<"% (de media)"<<endl;
			...
			cout<<"\tValor: "<<media_min<<"% (de media)"<<endl;
