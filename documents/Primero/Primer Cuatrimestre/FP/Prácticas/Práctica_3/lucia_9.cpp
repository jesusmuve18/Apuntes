...
int main()
{
	...
	tiempo_umbral_seg2 = (tiempo_umbral_seg-(tiempo_umbral_min*60));
	
	
	//Salidas:
	cout << "El tiempo umbral en segundos es: " << tiempo_umbral_seg<<endl;
	cout << "El tiempo umbral en minutos y segundos es:"<<endl<<"Minutos: " << tiempo_umbral_min<<endl;
