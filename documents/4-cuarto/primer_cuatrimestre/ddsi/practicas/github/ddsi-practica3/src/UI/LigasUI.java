...
public class LigasUI {
     
    public static JFrame main_menu_frame;
    
    /**
     * Menú principal del gestor de Ligas
     * @param parent Ventana a la que volver cuando se cierre esta
     * 
     * Mostrara 5 botones:
     * 1. Crear liga
     * 2. Dar de baja liga
     * 3. Modificar datos de liga
     * 4. Consultar clasificacion de liga
     * 5. Consultar estadisticas de liga
     */
    ...
    public static void MainMenu(JFrame parent) {
        ...
        if(main_menu_frame==null) {
            // Creamos la ventana
            main_menu_frame = new JFrame("Subsistema Gestion de Ligas");
            ...
            // Creamos los botones
            JButton boton1 = new JButton("Crear liga");
            JButton boton2 = new JButton("Dar de baja liga");
            JButton boton3 = new JButton("Modificar datos de liga");
            JButton boton4 = new JButton("Consultar clasificacion de liga");
            JButton boton5 = new JButton("Consultar estadisticas de liga");
