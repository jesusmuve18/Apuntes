(define (problem ejercicio2)
  ...
  (:objects
    ...
    Enano2                  - Personaje   ; en Isengard, no disponible

    ; Nodos de recursos
    NodoMineral_Moria, NodoMithril_Moria - NodoRecurso   ; Moria -> Mineral, Mithril
