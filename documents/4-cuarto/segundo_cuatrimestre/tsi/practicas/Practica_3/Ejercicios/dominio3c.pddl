(define (domain tierra-media)
  ...
  (:action Viajar
    ...
    :effect
      (and
        ...
        ; Destrucción de caminos si procede (ambas direcciones)
  ...
  ; ACCIÓN: formarComunidad  (3 Hobbits + 1 Mago)
  ;
  ; Reúne a los 4 personajes que constituirán la Comunidad del Anillo
  ; (tres Hobbits y un Mago) en una misma localización.
  ;
  ; Parámetros:
  ...
  ;   - ?p1, ?p2 y ?p3 son Hobbits y ?p4 es un Mago.
  ...
  (:action formarComunidad
    :parameters (?p1 - Personaje ?p2 - Personaje ?p3 - Personaje ?p4 - Personaje ?l - Localizacion)
    :precondition
      (and
  ...
  ; ACCIÓN: viajarComunidad  (4 miembros)
  ;
  ; Mueve a los 4 miembros de la Comunidad conjuntamente de una localización a otra.
  ...
  ;   - ?p1, ?p2 y ?p3 son Hobbits y ?p4 es un Mago. (para reducir el espacio de búsqueda)
  ;
  ; Efectos:
  ...
  (:action viajarComunidad
    :parameters (?p1 - Personaje ?p2 - Personaje ?p3 - Personaje ?p4 - Personaje ?org - Localizacion ?dst - Localizacion)
    :precondition
      (and
