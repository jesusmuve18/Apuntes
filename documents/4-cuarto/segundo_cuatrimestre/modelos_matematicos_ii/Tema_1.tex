...
Supongamos que $y_*$ es mínimo local para $\cc{F}$. Entonces existe un entorno tal que $\cc{F}[y_*] \leq \cc{F}[y]$ para todo $y$ en el entorno. Basta estudiar $\cc{F}[y_*+\veps\varphi]$ para $\varphi$ dirección admisible y $\veps << 1$. \\
