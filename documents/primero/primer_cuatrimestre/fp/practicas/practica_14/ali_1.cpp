/****************************************************************/
/*  FUNDAMENTOS DE PROGRAMACIÓN					EJERCICIO-51
	...
	de la matriz que más se parezca a un vector de enteros 
	(clase SecuenciaEnteros) al que llamaremos referencia. 
...
public:
							...
							filas_a_comparar, TablaRectangularEnteros matriz )
	{
		...
		for(int i = 0; i < filas_a_comparar.TotalUtilizados(); i++)
		{
			...
			for(int j=0; j < matriz.ColumnasUtilizadas(); j++)
			{
