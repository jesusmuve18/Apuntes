...
int main()
{
	...
	"rectangulitos" que tendrán de ancho el denominado SALTO y de alto el valor
	de la función en el punto. Al ser rectángulos el área se calculará como 
	base*altura de modo que el rectángulo en el punto x1 será:
	area=g(1)*SALTO, siendo g(1) la gaussiana en el punto.
	*/
	
	//Salidas
	
	cout<<"La CDF de una variable cualquiera Normal("<<mu<<","<<sigma<<") en "
		<<"x = "<<x_final<<" es: "<<endl;
	cout<<"\t"<<cdf<<endl;
