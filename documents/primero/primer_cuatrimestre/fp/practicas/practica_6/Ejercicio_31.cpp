/****************************************************************************/
//	FUNDAMENTOS DE PROGRAMACIÓN			RELACIÓN_II				EJERCICIO_31
/****************************************************************************/
/*
	...
	*/
	...
	if (hora_inic_ok) {
		...
		if (minuto_inic_ok) {
		    ...
		    cout << "Introduzca dinero disponible:" << endl;
			cout << "\tEuros:    ";
			cin >> dinero;	
	...
	if (datos_ok) {
		...
		while(precio+min_diferencia<dinero)
		{
			precio = 0; 
			num_mins++;
		...
		*/
					...
					if(min_diferencia==0)
						min_diferencia=CANT_MUY_MUY_LARGA;
				}
		...
		*/
				...
				if(min_diferencia==0)
					min_diferencia=CANT_CORTA;
				
		
			}		
		}
		
		minutos_final=mins_hora_inic+num_mins;
		
		cout<<"Minutos final= "<<minutos_final<<endl;
		
		dias_final=(minutos_final/MINS_DIA);
		minutos_final=(minutos_final%MINS_DIA);
		horas_final=(minutos_final/MINS_HORA);
		minutos_final=(minutos_final%MINS_HORA);
	...
	if (datos_ok) {
		...
		cout << endl;
		cout << "Tarifa final =  " <<setw(6)<< setprecision(2)<< precio
			 << " euros" << endl;
		cout << endl;
		...
		cout << endl;
		cout<<"Hora de salida estimada: "<<endl;
		cout<<"\tDias: "<<dias_final<<endl;
		cout<<"\tHoras: "<<horas_final<<endl;
		cout<<"\tMinutos: "<<minutos_final<<endl;
		...
		if (!hora_inic_ok) {
			...
			cout << endl; 
 			...
 			cout << endl; 
			cout << "ERROR: Dinero incorrecto."<< endl; 
			cout << endl; 	
		 }	 
	}
