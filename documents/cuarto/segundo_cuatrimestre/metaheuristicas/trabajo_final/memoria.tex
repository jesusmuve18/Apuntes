...
El DE obtiene el mejor resultado en 21 de las 30 funciones, el PSO en 9, y el SCA en ninguna. Este resultado, aunque no beneficia a SCA, es coherente con las limitaciones teóricas identificadas más adelante (Sección \ref{sec:resumen_motivacion}): el decrecimiento lineal de $r_1$ activa la explotación demasiado pronto, y la ausencia de memoria colectiva entre agentes dificulta la convergencia en funciones multimodales.
...
\begin{table}[H]
\centering
\caption{Número de funciones ganadas por algoritmo en \textit{milestones} representativos ($d=10$, con ASCA).}
...
\begin{table}[H]
\centering
\caption{Número de funciones ganadas por algoritmo en \textit{milestones} representativos ($d=50$, con ASCA).}
