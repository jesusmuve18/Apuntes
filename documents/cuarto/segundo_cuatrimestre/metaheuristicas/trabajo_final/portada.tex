...
\define@key{portada}{dni}{\def\dni{#1}}
\define@key{portada}{horario practicas}{\def\horariopracticas{#1}}
\define@key{portada}{email}{\def\email{#1}}
...
\newcommand*{\portada}[1][]{%
  ...
  \setkeys{portada}{%
    ...
    año=Sin Año,%
    color página=white,%
    imagen=Logo-UGR.png, #1}%
    \begin{titlepage}
        \centering
        \pagecolor{\colorpagina} % Cambia el color de fondo de la portada
        {\includegraphics[height=0.2\textwidth]{\imagen}\par}
        \vspace{1cm}
