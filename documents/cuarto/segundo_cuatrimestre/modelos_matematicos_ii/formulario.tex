...
\begin{document} 
    ...
    \begin{definicion}[Clase de Schwartz] Se define la \textbf{clase de Schwartz} como el espacio funcional 
        ...
        \end{gather*}
        esto es, el formado por todas las funciones complejas infinitamente diferencaibles tales que tanto ellas como todas sus derivadas decrecen en infinito más rápido que cualquier polinomio.
    \end{definicion}
    ...
    \begin{definicion}
        Dada $f,g: \bb{R}\to \cc{C}$ se define $(f\ast g) : \bb{R}\to \bb{C}$ como 
        \begin{gather*}
