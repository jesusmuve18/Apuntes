/****************************************************************************/
//	FUNDAMENTOS DE PROGRAMACIÓN			RELACIÓN_V				EJERCICIO_48
/****************************************************************************/
/*
	...
	En el ejercicio 33 de la Relación de Problemas IV definimos un nuevo 
	criterio de orden entre dos números enteros positivos: Un valor entero a 
	será mayor que otro b si el número de dígitos nueve es mayor en a que en
	b. Si el número de nueves es igual en los dos, el mayor será el que tiene 
	más ochos.
	...
	Bastará una ligera modificación en los métodos implementados en el 
	ejercicio 47).
	...
	aleatorios entre 0 y 999, la ordene con los métodos implementados y 
