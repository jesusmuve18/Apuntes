/****************************************************************************/
//	FUNDAMENTOS DE PROGRAMACIÓN			RELACIÓN_VI				EJERCICIO_20
/****************************************************************************/
/*
	...
	Enunciado:
	 ...
	 (Examen Conv. Extraordinaria Febrero 2022) Un palíndromo es una secuencia 
	 que se lee igual de izquierda a derecha que de derecha a izquierda. Se 
	 pide que defina un método que calcule y devuelva el palíndromo de mayor 
	 longitud contenido en una secuencia. Dicho palíndromo siempre existe y 
	 será un objeto de la clase SecuenciaCaracteres.
	 
	SecuenciaCaracteres MayorPalindromoContenido (void);
	
	Si hay varios con la misma longitud, tiene libertad para elegir cuál de 
	ellos devolver.
	
	Por ejemplo, el mayor palíndromo contenido en CABBADE es la subsecuencia 
	ABBA, mientras que el mayor palíndromo contenido en ABCDEF es cualquiera 
	de las subsecuencias de tamaño 1, por ejemplo A. El mayor palíndromo 
	contenido en ABBA es la subsecuencia ABBA, y el mayor palíndromo en 
	gAAtySHHSvvABCCBAfh es la subsecuencia ABCCBA.


	Salidas: Secuencia generada y palíndromo de mayor longitud
