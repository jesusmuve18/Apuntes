...
# --- Rutas ---
SRC="/home/jesusmuve/Escritorio/Apuntes/documents/5-quinto/primer_cuatrimestre/geometria_global"
DEST="/home/jesusmuve/Documentos/git clones/LosDelDGIIM.github.io/subjects/Geometría Global/Temario"
REPO_DIR="/home/jesusmuve/Documentos/git clones/LosDelDGIIM.github.io"

MAIN_TEXFILE="Temario_GeoGlobal.tex"
...
cp "$SRC"/losDelDGIIM/$MAIN_TEXFILE "$DEST"/

# --- Paso 5: compilar el TeX ---
cd "$DEST" || { echo "No se pudo entrar a la carpeta de destino"; exit 1; }
echo "Compilando $MAIN_TEXFILE..."
latexmk -pdf -shell-escape -interaction=nonstopmode $MAIN_TEXFILE > /dev/null 2>&1
latexmk -c
rm -rf ./_minted-*
...
cd "$REPO_DIR" || exit 1
git add "subjects/Geometría Global/Temario"
git commit -m "Actualizado temario Geometría Global [$FECHA]"
