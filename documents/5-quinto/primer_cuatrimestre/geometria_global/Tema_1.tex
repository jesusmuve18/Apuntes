...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \end{gather*}
        y tenemos que existe $\tilde{\alpha} : \bb{R}/R_\alpha \to C$ continua y biyectiva. Para ver que es un homeomorfismo basta con ver que $\tilde{\alpha}$ es cerrada, y lo es porque sale de un compacto ($S^1$) y llega a un espacio T2 ($C$ es T2 porque lo hereda de $\bb{R}$). Por tanto
        \begin{gather*}
