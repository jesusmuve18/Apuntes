...
\begin{observacion}
    ...
    \begin{enumerate}
        ...
        % Las únicas 2 que son posibles son las que cortan en 2 lados contiguos del rectángulo o 2 lados opuestos paralelos.
        ...
        Llamamos $S$ al segmento que corta en 2 lados opuestos (horizontales) y tenemos que 
        \begin{gather*}
        ...
        Pero en este caso no serían grafos sobre $\alpha^{-1}(W)$ ni sobre $\beta^{-1}(W)$ por lo que rechazamos esta posibilidad.\\
        ...
        Y en el primer caso no es un grafo sobre $\beta^{-1}(W)$ y el segundo no lo sería sobre $\alpha^{-1}(W)$ por lo que descartamos esta opción también.
        ...
        Nos planteamos las posibilidades que nos quedan
